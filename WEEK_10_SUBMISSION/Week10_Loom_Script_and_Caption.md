...
| 0:50–0:55 | **Pan to Error Trigger + Log to Unified Drain nodes** → click to show the Execute Workflow config pointing to centralized Telegram log-drain | *"Resiliency engine catches every failure."* |
